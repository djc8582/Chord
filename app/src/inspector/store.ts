...
export const PARAMETER_DEFINITIONS: Record<string, ParameterDescriptor[]> = {
  oscillator: [
    { id: "frequency", label: "Frequency", min: 20, max: 20000, step: 1, defaultValue: 440, unit: "Hz" },
    { id: "detune", label: "Detune", min: -100, max: 100, step: 1, defaultValue: 0, unit: "cents" },
    { id: "waveform", label: "Waveform", min: 0, max: 3, step: 1, defaultValue: 0, unit: "" },
    { id: "gain", label: "Gain", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
  ],
  filter: [
    { id: "cutoff", label: "Cutoff", min: 20, max: 20000, step: 1, defaultValue: 1000, unit: "Hz" },
    { id: "resonance", label: "Resonance", min: 0, max: 1, step: 0.01, defaultValue: 0, unit: "" },
    { id: "type", label: "Type", min: 0, max: 3, step: 1, defaultValue: 0, unit: "" },
  ],
  gain: [
    { id: "gain", label: "Gain", min: 0, max: 2, step: 0.01, defaultValue: 1, unit: "" },
  ],
  envelope: [
    { id: "attack", label: "Attack", min: 0, max: 5, step: 0.001, defaultValue: 0.01, unit: "s" },
    { id: "decay", label: "Decay", min: 0, max: 5, step: 0.001, defaultValue: 0.1, unit: "s" },
    { id: "sustain", label: "Sustain", min: 0, max: 1, step: 0.01, defaultValue: 0.7, unit: "" },
    { id: "release", label: "Release", min: 0, max: 10, step: 0.001, defaultValue: 0.3, unit: "s" },
  ],
  lfo: [
  ...
  mixer: [
    { id: "level1", label: "Level 1", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
    { id: "level2", label: "Level 2", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
    { id: "level3", label: "Level 3", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
    { id: "level4", label: "Level 4", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
  ],
  delay: [
    { id: "time", label: "Time", min: 0, max: 5, step: 0.001, defaultValue: 0.5, unit: "s" },
    { id: "feedback", label: "Feedback", min: 0, max: 0.99, step: 0.01, defaultValue: 0.5, unit: "" },
    { id: "mix", label: "Mix", min: 0, max: 1, step: 0.01, defaultValue: 0.5, unit: "" },
  ],
  reverb: [
    { id: "size", label: "Size", min: 0, max: 1, step: 0.01, defaultValue: 0.5, unit: "" },
  ...
  output: [
    { id: "volume", label: "Volume", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
  ],
  input: [
    { id: "gain", label: "Gain", min: 0, max: 2, step: 0.01, defaultValue: 1, unit: "" },
  ],
  midi_in: [],
  noise: [
    { id: "type", label: "Type", min: 0, max: 2, step: 1, defaultValue: 0, unit: "" },
    { id: "gain", label: "Gain", min: 0, max: 1, step: 0.01, defaultValue: 1, unit: "" },
  ],
};
